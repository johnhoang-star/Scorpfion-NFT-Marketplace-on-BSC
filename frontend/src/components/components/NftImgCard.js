...
const NftImgCard = ({ nft, className = 'd-item col-lg-3 col-md-6 col-sm-6 col-xs-12 mb-4', clockTop = true, height, onImgLoad, loaded, key }) => {
    ...
    return (
        <div className={className}>
            <div className="nft__item m-0">
                ...
                <Outer>
                    <span>
                        <img onLoad={onImgLoad} src={nft.ImgUrl} className="lazy nft__item_preview" alt=""/>
...
export default memo(NftImgCard);